                        ...
                        <div className='col l8 m8 s8'>
                            <div id={style.nav}>
                                ...
                                <div className={style.desktopMode}>
                                    <ul>
                                        {/* <List links={link} path={this.props.pathLocation.pathname}/> */}
                                        <li>
                                        ...
                                        <li>
                                            <Link to="/about-the-author" activeClassName={style.active}>
                                                About the Author
					</Link>
                                        </li>
                                        <li>
                                            <Link to="/about-the-book" activeClassName={style.active}>
                                                About the Book
					</Link>
                                        </li>
                                        <li>
